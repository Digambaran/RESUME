...
\AddToHook{shipout/foreground}{%
  \put(33\baselineskip,-\paperheight+.5\baselineskip)
    {\tiny\textit{document prepared with \LaTeX.source at \href{https://github.com/Digambaran/Resume}{https://github.com/Digambaran/Resume}}}
}
%-------------------------------------------------------------
...
\begin{minipage}[t]{0.275\textwidth} % 27.5% of the page width for the first row of icons
	...
	\icon{At}{12}{\href{mailto:arjunsreekumar.1@gmail.com}{arjunsreekumar.1@gmail}}\\	
\end{minipage}
\begin{minipage}[t]{0.275\textwidth} % 27.5% of the page width for the second row of icons
	...
	\icon{Github}{12}{\href{https://www.github.com/Digambaran}{github.com/Digambaran}}\\
	\icon{Linkedin}{12}{\href{https://www.linkedin.com/in/arjunskumar1995427}{arjunskumar1995427}}\\
\end{minipage}
...
\begin{minipage}[t]{0.5\textwidth} % 50% of the page for the skills bar chart
	\vspace{-\baselineskip} % Required for vertically aligning minipages
	\chips{javascript}\chips{typescript}\chips{html}\chips{css}\chips{React.Js}\chips{react-redux}\chips{next.js}\chips{Node.Js}\chips{rust}\chips{docker}\chips{mysql}\chips{git}\chips{Vue.Js}\chips{vuex}\chips{mongodb}\chips{storybook}
\end{minipage}
...
\cvsect{Hobbies}
\smallskip\\
\graychips{photography}\graychips{art}\graychips{reading}\graychips{cycling}
